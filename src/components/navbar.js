...
const navbar = () => {
    ...
    elemcreater({
        prop: "div#homebtn.navdiv.linkbtn", parentId: 'homelink',
        text: 'Home'
    })
    ...
    elemcreater({
        prop: "div#todaybtn.navdiv.linkbtn", parentId: 'todaylink',
        text: 'Today'
    })
    //creating week <a> tag
    elemcreater({
    ...
    elemcreater({
        prop: "div#weekbtn.navdiv.linkbtn", parentId: 'weeklink',
        text: 'Week'
    })
    ...
    elemcreater({
        prop: "button#projectbtn", parentId: 'projbtn',
        text:'projects'
    })
    ...
    elemcreater({
        prop: "div#notesbtn.navdiv.linkbtn", parentId: 'noteslink',
        text: 'Notes'
    })
    projfns()
}
